sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	function(Controller, MessageToast, JSONModel) {
		"use strict"; 
		return Controller.extend("PosClient.controller.PostReceiptMaster", {
			/**
			...
			onInit: function() {
				...
				// 		var PostReceiptModel = new JSONModel(customerData);
...
//				var filterToday = year + '-' + month + '-' + day;
			...
			_onRouteMatched: function(oEvent) {
				if (oEvent.getParameter("name") === "PostReceiptMaster") {
			...
			_showDetail: function(oItem) {
				...
				var itempath = oItem.getBindingContext("PostReceiptModel");
				var vbeln = itempath.getObject().vbeln;
				// var shipto = itempath.getObject().shipto;
//                var shipto;
				this.getOwnerComponent().getRouter().navTo("PostReceiptDetail", {
					vbeln: vbeln
				}, true);
			},
